...
<#list parent.children as child>
	...
	<li class="category"><a href="${root_url}${child.url}">${child.name}</a><span class="count right">${child.posts?size}</span></li>
...
<#list site.categories as category>
	...
	<li class="category"><a href="${root_url}${category.url}">${category.name}</a><span class="count right">${category.posts?size}</span></li>
